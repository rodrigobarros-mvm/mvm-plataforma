        ...
        <div className="flex flex-col items-center gap-6 p-8 max-w-md w-full text-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Faça login para acessar a plataforma LN Máquinas.
            </p>
          </div>
          <Button
        ...
        <Sidebar collapsible="icon" className="border-r-0" disableTransition={isResizing}>
          ...
          <SidebarHeader className="h-16 justify-center border-b border-sidebar-border">
            <div className="flex items-center gap-3 px-2 w-full">
              ...
              >
                <PanelLeft className="h-4 w-4" style={{ color: "#F5A623" }} />
              </button>
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  <div className="h-7 flex items-center shrink-0">
                    <img src="/manus-storage/LOGOLN_191337c8.png" alt="LN Máquinas" className="h-full object-contain" />
                  </div>
          ...
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-4 backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-foreground" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>LN Máquinas</span>
              </div>
            </div>
